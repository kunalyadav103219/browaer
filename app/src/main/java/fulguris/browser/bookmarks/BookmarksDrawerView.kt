...
class BookmarksDrawerView @JvmOverloads constructor(
    ...
    init {
        ...
        iAdapter = BookmarksAdapter(context, webBrowser, bookmarkModel, faviconModel, networkScheduler, mainScheduler, databaseScheduler, ::showBookmarkMenu, ::openBookmark
            )
