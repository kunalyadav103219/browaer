...
//    fun loadHomePage() {
//        val homePageUrl = if (isIncognito) {
//            Uris.FulgurisIncognito
//        } else {
//            Uris.FulgurisHome
//        }
//
//        // Find the current tab where the homepage is set
//        val tabWithHomePage = tabsManager.find { it.url == homePageUrl }
//        for (k in tabsManager.)
//
//
//        // If a tab with the homepage URL is found, set it as the current tab URL
//        if (tabWithHomePage != null) {
//            iTargetUrl = Uri.parse(homePageUrl)
//            initializeContent(homePageInitializer)
//        } else {
//            // If no tab with the homepage URL is found, create a new tab with the homepage URL
//            // and set it as the current tab
//            iTargetUrl = Uri.parse(homePageUrl)
//            getTabsManager().addTab(iTargetUrl.toString(), true)
//        }
//    }
