...
//        val skip = Build.VERSION.SDK_INT == Build.VERSION_CODES.S
    ...
    private lateinit var runnable: Runnable
            ...
            override fun onCreate(savedInstanceState: Bundle?) {
               super.onCreate(savedInstanceState)
                ...
                myApplication.appOpenAdsManager.loadAd()
...
//            val myApplication = application as MyApplication
                    ...
                    if (myApplication.appOpenAdsManager.isAdLoaded) {
                        myApplication.appOpenAdsManager.showAdIfAvailable(
                            this,
                            object : AppOpenAdsManager.OnAdCompleteListener {
                        ...
                        if (i == 25) {
                            ...
                            // Stop the runnable from executing further
                            handler.removeCallbacks(runnable)
                        } else {
